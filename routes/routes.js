    ...
    use: (app, express, db) => {
        ...
        app.get('/why-tue', (req, res) => {
            res.render('default.html', {
                heading: "Why TU/e!",
                content: '<div id="pagetitle"><h1>Why study at TU/e?</h1></div><div id="c12537"><div class="ce-textpic ce-right ce-intext"><div class="ce-gallery" data-ce-columns="1" data-ce-images="1"><div class="ce-row"><div class="ce-column"><div class="ce-media"><img src="https://static.tue.nl/fileadmin/_processed_/8/b/csm_logo01_4c920aa3e4.jpg" width="200" height="133" style="float: right;" alt=""> </div></div></div></div><div class="ce-bodytext"><p>Studying at TU/e means studying at a Dutch top university. A university with a unique <a href="/en/education/tue-bachelor-college/">Bachelor College</a> and its own <a href="/en/education/tue-graduate-school/">Graduate School</a>.</p><p><strong>High ranking <br></strong>That’s evident from the high position of our university in <a href="/en/education/studying-at-tue/why-study-at-tue/tue-in-inter-national-rankings/">national and international rankings</a>.<br><br><strong>TU/e is a good choice </strong><br>It is not only the high independent ranking positions that make TU/e a good place to study. Studying at Eindhoven University of Technology means that you choose a university with top quality <a href="/en/education/studying-at-tue/why-study-at-tue/excellent-education/">education</a> and internationally prominent <a href="/en/education/studying-at-tue/why-study-at-tue/internationally-prominent-research/">research</a>.<br><br><strong>Personal contact</strong><br>TU/e is a medium-sized university with an open, friendly atmosphere where your studies are well supervised and where there is plenty of personal contact with lecturers and staff. Experienced TU/e coaches are by your side to offer personal advice from the very start of your study, from the moment you enroll at the Bachelor College when you and your coach look at the major that best suits you and how you can best supplement this with your electives. And if you should find out during your first year that a different major suits you better, then you can look at the options with your coach for switching major within this first year.</p><p><strong>International contacts</strong><br>TU/e offers you excellent facilities and there are many <a href="/en/education/studying-at-tue/why-study-at-tue/inter-national-partnerships/">international contacts</a> with leading universities. A period studying at a university abroad is one of the possibilities.<br><br><strong>TU/e and society</strong><br>‘<a href="/en/education/studying-at-tue/why-study-at-tue/where-innovation-starts/">Where innovation starts’</a> is the TU/e slogan for very good reasons. The university is meeting the societal challenges especially in the fields of health, energy and mobility. As a TU/e Master of Science graduate you have the prospect of a variable, challenging, lucrative and socially useful career.</p><p><strong>Top technology region <br></strong>TU/e lies in the top technology region of <a href="http://www.brainport.nl/" target="_blank">Brainport</a>, the beating technological heart of the Netherlands. <a href="/en/education/studying-at-tue/why-study-at-tue/tue-and-industry/">Relationships with high-tech companies and organizations</a> in the region are many and good, and that bears fruit for you in your assignments, internships, graduation projects and work.<br><br><strong>Eindhoven student city<br></strong>Eindhoven is a modern, dynamic city that guarantees an enjoyable study period and varied student life. The vibrant spirit liveliness of Eindhoven along with the exuberant Brabant way of life will make you feel at home.</p><p><strong>Match-making event</strong><br>During the match-making event you get the opportunity to meet companies. International master students at Eindhoven University of Technology (TU/e) with an Amandus Lundqvist Scholarship Program (ALSP) are brought into contact with companies that participate in the ALSP program. If there is a match between you and a company you receive a scholarship from that company for your Master’s program at TU/e. After you graduate, you will be working for that company for 3 consecutive years. </p></div></div></div>'
            });
        });
